...
const ossSiteAssetUrl = "https://ecs-oss-ist.oss-cn-hangzhou.aliyuncs.com/site_asset";
const ossImage = (name: string) => `${ossSiteAssetUrl}/${name}`;
...
const narrativeScenes: NarrativeScene[] = [
  { id: "classroom", title: "互动课堂", description: "完整生成适用于任何学科的互动游戏课堂", icon: "✦", ready: true, tone: "sun", image: ossImage("scene-interactive-classroom.png") },
  { id: "practice", title: "讲练工具", description: "课堂辅助讲评练工具", icon: "⌁", tone: "violet", image: ossImage("scene-practice-tools.png") },
  { id: "visual", title: "画面设计", description: "一句提示词生成恰当的图片、人物与场景设计稿", icon: "◐", tone: "blue", image: ossImage("scene-visual-design.png") },
  { id: "outline", title: "创意大纲", description: "用一句话帮你确定想写的故事大纲", icon: "✎", tone: "rose", image: ossImage("scene-creative-outline.png") },
...
function NarrativeRouterPage() {
  ...
  return <main className="narrative-router">
    ...
    <section className="router-solutions" aria-labelledby="solutions-title"><div className="solutions-heading"><p>CHOOSE YOUR PATH</p><h2 id="solutions-title">选择最符合你需求的 NarrativeOS 解决方案</h2></div><div className="solution-grid">
      <article className="solution-card one"><img className="solution-cover" src={ossImage("solution-narrativeos-one.png")} alt="" /><span className="solution-shade" /><span>01</span><h3>NarrativeOS <b>One</b></h3><p>适合学生、教师、家长和个人创作者的一站式互动叙事创作平台</p><button type="button" onClick={() => setPickerOpen(true)}>开始创作 <i>→</i></button></article>
