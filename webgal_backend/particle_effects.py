...
EFFECT_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "rain": {
        "id": "rain",
        "label": "雨",
        "description": "连续下落的雨线，适合阴雨、压迫感与安静的室外场景。",
        "asset": "rain.png",
        "count": 90,
        "speed": 18.0,
        "scale": 0.42,
        ...
        "layer": "foreground",
        "blend_mode": "screen",
        "sheet": {"frame_width": 128, "frame_height": 640, "frame_count": 5, "columns": 5},
    },
    "snow": {
        "id": "snow",
        "label": "雪",
        "description": "轻缓飘落的雪花，适合冬日、寂静和柔和氛围。",
        "asset": "snow.png",
        "count": 75,
        "speed": 2.4,
        "scale": 0.38,
    ...
    "cherry_blossoms": {
        "id": "cherry_blossoms",
        "label": "樱花",
        "description": "花瓣随风缓慢飘落，适合春日、回忆和浪漫场景。",
        "asset": "cherryBlossoms.webp",
        "count": 42,
        "speed": 2.8,
        "scale": 0.16,
        "angle": 105.0,
        ...
        "layer": "foreground",
        "blend_mode": "normal",
        "sheet": {"frame_width": 529, "frame_height": 678, "frame_count": 1, "columns": 1},
    },
}
